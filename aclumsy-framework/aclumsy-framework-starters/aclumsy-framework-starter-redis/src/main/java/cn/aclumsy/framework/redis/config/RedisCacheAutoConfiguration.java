...
import cn.aclumsy.framework.redis.client.RedisClient;
import cn.aclumsy.framework.redis.annotation.ExpireRedisCacheWriter;
import cn.aclumsy.framework.redis.aspect.CacheExpireAspect;
...
public class RedisCacheAutoConfiguration extends CachingConfigurerSupport {
    ...
    public RedisCacheAutoConfiguration() {
        ...
        timeModule.addDeserializer(LocalDate.class, new LocalDateDeserializer(DateTimeFormatter.ofPattern(PatternConstant.DATE_PATTERN)));
        timeModule.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(PatternConstant.DATETIME_PATTERN)));
        timeModule.addSerializer(LocalDate.class, new LocalDateSerializer(DateTimeFormatter.ofPattern(PatternConstant.DATE_PATTERN)));
        timeModule.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(PatternConstant.DATETIME_PATTERN)));
