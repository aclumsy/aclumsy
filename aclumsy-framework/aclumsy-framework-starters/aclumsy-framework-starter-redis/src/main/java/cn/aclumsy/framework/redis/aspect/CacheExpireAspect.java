package cn.aclumsy.framework.redis.aspect;


import cn.aclumsy.framework.redis.annotation.CacheExpire;
import cn.aclumsy.framework.redis.annotation.CacheExpireHolder;
...
public class CacheExpireAspect {
     ...
     * 设置方法对应的缓存过期时间
     */
    @Around("@annotation(cn.aclumsy.framework.redis.annotation.CacheExpire)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logger.info("缓存切面，设置过期时间{}ms", cacheExpiredMilliseconds + floatRangeMilliseconds);
        try {
